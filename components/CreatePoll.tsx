...
const CreatePoll: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="bg-[#e3e2e2] text-[#151515] shadow-lg shadow-[#1B5CFE] rounded-xl w-11/12 md:w-2/5 h-7/12 p-6">
        <div className="flex flex-col">
          <div className="flex flex-row justify-between items-center">
            <p className="font-semibold">Add Poll</p>
            <button onClick={closeModal} className="border-0 bg-transparent text-white focus:outline-none">
          ...
          >
            <div className="py-4 w-full border border-[#212D4A] rounded-full flex items-center px-4 mb-3 mt-2">
              <input
                ...
                className="bg-transparent outline-none w-full placeholder-[#545353] text-sm"
                name="title"
                value={poll.title}
            ...
            >
              <span
                className="bg-[#1B5CFE] bg-opacity-20 text-[#556ab7]
                absolute left-[2.5px] py-3 rounded-full px-5 w-48"
              >
                <span  className='text-transparent'>.</span>
              </span>
