...
const ContestPoll: React.FC<{ poll: PollStruct }> = ({ poll }) => {
  ...
  return (
    ...
    bg-[#030c0f]  bg-opacity-80 transform z-50 transition-transform duration-300 ${contestModal}`}
    >
      <div className="bg-[#071714] text-[#BBBBBB] shadow-sm shadow-[#e9e47a]   backdrop-blur-lg rounded-xl w-11/12 md:w-2/5 h-7/12 p-6">
          ...
          >
            ...
            <button
              className="h-[48px] w-full block mt-2 px-3 rounded-full text-sm font-bold
                transition-all duration-300  bg-yellow-600 hover:bg-yellow-700"
            >
              Contest Now
            </button>
          </form>
